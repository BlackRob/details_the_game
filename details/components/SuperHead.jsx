...
const SuperHead = ({ gameState }) => {
  return (
    <Head>
      ...
      <meta property="og:image" content={`https://details.grumbly.games/api/${gameState}`} />
      <meta property="og:image:secure_url" content={`https://details.grumbly.games/api/${gameState}`} />
      <meta property="og:image:width" content="1200" />
      <meta property="og:image:height" content="630" />
      <meta property="og:image" content={`https://details.grumbly.games/api/square/${gameState}.png`} />
      <meta property="og:image:width" content="600" />
      <meta property="og:image:height" content="600" />
      <meta property="fb:app_id" content="220488252548780" />
      <meta property="og:type" content="website" />
      <meta property="og:url" content={`https://details.grumbly.games/${gameState}`} />
      ...
      <meta name="twitter:image" content={`https://details.grumbly.games/api/${gameState}`} />
      <meta name="twitter:domain" content={`https://details.grumbly.games/${gameState}`} />
    </Head>
  )
}
