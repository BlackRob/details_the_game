        ...
        <Fold
          ...
          content={
            <>
              ...
              <p>
                Coordinating conjunctions are subdivided into smaller groups
                based on how they are used. Coordinating conjunctions also have
                to come between the words or phrases they modify (although
                sometimes these same words can be used as subordinating
                conjunctions or adverbs, which don't follow the same "must come
                between" rule).
              </p>
              ...
              <p className="example">
                <Conj x="Neither" /> <Noun x="Bill" /> <Conj x="nor" />{" "}
                <Noun x="Angelica" /> won the race.
              </p>
              <p>Alternatively (to avoid the word "neither"):</p>
              <p className="example">
                Bill <Verb x="did" /> <Adv x="not" /> win the race,{" "}
                <Conj x="nor" /> <Verb x="did" /> Angelica.
              </p>
              <h4>But</h4>
              <p>
          ...
          content={
            <>
              <p>
                ...
                the subordinate clause goes first it's followed by a comma.
              </p>
              <p>
                This might sound complicated, but it isn't really. You just need
                to remember a few things:
              </p>
              <ol>
                <li>
                  A clause is a group of words that has a noun and a verb, but
                  isn't it's own sentence
                </li>
                <li>
                ...
                <li>
                  ...
                  clause, but if it comes first it has to be followed by a comma
                </li>
              </ol>
              <p>Which just means that you can write </p>
              <p className="example">
              ...
              <p>
                Note that the <i>main clause</i> is "I gave my daughter a
                cookie", and the <i>subordinate clause</i> is "she was hungry".
                It should be clear that the main clause is more important. The
                subordinate clause only exists to provide extra details about
                the main clause (in this case, answering <i>why?</i>).
              </p>
            </>
          }
        />
        <p>
          <sup>1</sup> The value of this acronym is debateable --read{" "}
          <a href="https://www.quickanddirtytips.com/education/grammar/weird-coordinating-conjunctions-yet-for-and-so">
            this
          </a>{" "}
          to understand why-- but for our purpose here (to remember what our
          choices are when we have to choose a conjunction to use) it will
          suffice.
        </p>
      </div>
