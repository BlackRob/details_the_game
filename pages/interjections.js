    ...
    <main>
      ...
      <div className="content">
        <Fold title={<h3>How to use interjections in details</h3>} content={<>
          ...
          <p className="example"><Intrj x="Shit" /><Punc x="!" /> I dropped my phone.</p>
          ...
          they are set off by either commas or double hyphens (see below).</p>
        </>} />
        <Fold title={<h3>Placing an interjection in a sentence</h3>} content={<>
          <p>The last example used an interjection at the beginnning of a sentence,
          but they can also be placed at the end of a sentence:</p>
          <p className="example">Mom is cooking spiders for dinner. <Intrj x="Gross" /><Punc x="!" /></p>
          <p>Sometimes they can even be used in the middle of a sentence:</p>
          <p className="example">My brother said <Punc x="--" /><Intrj x="so stupid" /><Punc x="--" />&nbsp;
           that bats only eat cheese.</p>
        </>} />
        <Fold title={<h3>Not all interjections are one word, not all lone words are interjections</h3>} content={<>
          ...
          <p className="example"><Intrj x="Wow" /><Punc x="!" />&nbsp;<Noun x="Karen" /><Punc x="!" />&nbsp;
          <Verb x="Look" /><Punc x="!" /></p>
          <p>Only the first word is an interjection. The second is a noun, using "direct address"
          (calling someone by their name). The last is a verb in the imperative mood (a command).</p>
        </>} />
        <Fold title={<h3>Interjection magic: swearing without swearing</h3>} content={<>
          ...
          that might offend people. For example, my grandmother used to say&nbsp;
          <span className="sBG"><Intrj x="Oh sugar" /><Punc x="!" /></span>&nbsp;
          instead of <span className="sBG"><Intrj x="Shit" /><Punc x="!" /></span>,&nbsp;
          and people often say <span className="sBG"><Intrj x="Fudge" /><Punc x="!" /></span>&nbsp;
          instead of another, less polite "fu" word. When a word is used this way, it's called a <i>euphemism</i>,
          which just means that one word is taking the place of another one.</p>
        </>} />
      </div>
